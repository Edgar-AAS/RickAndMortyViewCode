    ...
    extension GenericListViewController: UICollectionViewDelegate {
        ...
        func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
            let detailViewController = DetailViewController(character: viewModel.loadCurrentCharacter(indexPath: indexPath), viewModel: DetailViewModel(characterData: viewModel.loadCurrentCharacter(indexPath: indexPath)))
